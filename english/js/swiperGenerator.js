    ...
    const cargarPeliculas = async() => {
        ...
        if (isSerie.checked) {
            try {
                ...
                const respuesta = await fetch(`https://api.themoviedb.org/3/tv/${serieKey}?api_key=32e579ecd7dff257b062abbd70cb8032&language=${languaje}`);
...
<div class="swiper-slide">
    <div class="bs-card">
        ...
        <div class="card-content">
            ...
            <div>
                <a class="btn btn-blur" href="#"><i class="fa-solid fa-play" /> Watch now</a>
            </div>
        </div>
    </div>
</div>
...
`;
        ...
        if(isMovie.checked){
            ...
            const respuesta = await fetch(`https://api.themoviedb.org/3/movie/${serieKey}?api_key=32e579ecd7dff257b062abbd70cb8032&language=${languaje}`);
